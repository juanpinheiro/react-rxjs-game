...
import { combineLatest, Observable, interval, range } from 'rxjs';
import { distinctUntilChanged, map, switchMap, zip, skip, throttleTime, filter } from 'rxjs/operators';
...
const INITIAL_STATE: IMovementState = {
    coordinates: new Vector2(),
    position: new Vector2()
}

class MovementService extends Store<IMovementState> {
